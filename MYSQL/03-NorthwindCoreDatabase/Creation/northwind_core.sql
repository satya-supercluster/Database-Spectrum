...
CREATE TABLE Territory (
    ...
    PRIMARY KEY (entityId),
    UNIQUE INDEX IDX_TerrytoryCode (territoryCode),
...
CREATE TABLE CustomerCustomerDemographics (
    ...
    FOREIGN KEY (customerTypeId) REFERENCES CustomerDemographics (entityId)
) ENGINE = INNODB;
...
CREATE TABLE EmployeeTerritory (
    ...
    territoryCode VARCHAR(20) NOT NULL,
    PRIMARY KEY (entityId),
    FOREIGN KEY (employeeId) REFERENCES Employee (entityId),
    FOREIGN KEY (territoryCode) REFERENCES Territory (territoryCode)
) ENGINE = INNODB;
...
ADD UNIQUE INDEX IDX_TerritoryCode_RegionId (territoryCode, regionId);

ALTER TABLE CustomerCustomerDemographics
ADD UNIQUE INDEX IDX_CustomerId_CustomerTypeId (customerId, customerTypeId);

ALTER TABLE EmployeeTerritory
ADD UNIQUE INDEX IDX_EmployeeId_TerritoryCode (employeeId, territoryCode);

ALTER TABLE OrderDetail
ADD UNIQUE INDEX IDX_OrderId_ProductId (orderId, productId);
